...
public class ReporteController {
    ...
    @GetMapping("/history")
    public ResponseEntity<List<InformacionResponseDTO>> getReportHistory(@RequestParam String userId) {
    ...
    public ResponseEntity<Void> deleteAllUserReports(@PathVariable String userId) {
